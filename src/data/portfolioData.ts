...
export const experience = [
    {
        ...
        period: 'Present',
        description: 'Mantenimiento del código y documentación para asegurar la calidad y continuidad de los proyectos. Análisis y desarrollo de accesibilidad en aplicaciones web y móviles, implementando soluciones inclusivas.',
        tech: ['TypeScript', 'React', 'Next.js', 'Accessibility'],
    },
];
